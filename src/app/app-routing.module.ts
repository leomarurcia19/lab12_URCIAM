...
import { FormProductosComponent } from './components/dashboard/form-productos/form-productos.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [AuthGuard], // Aplicar el guardia de ruta a las rutas protegidas
    children: [
